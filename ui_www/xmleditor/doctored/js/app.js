    ...
    doctored._init = function(selector, options){ // returns an instance of the editor
        ...
        instance = {
            ...
            init: function(){ //initialize one instance of the editor
                ...
                this.menu.innerHTML = '<a class="doctored-properties" href="" title="Document Properties">Document</a><a class="doctored-view-source" href="">View Source</a>'+ 
                	'<a class=\"doctored-download\" href=\"\">Download</a>' + 
                '<a class=\"doctored-save\" href=\"\">Save</a>';
                ...
                this.menu.save = $(".doctored-save", this.menu)[0];
                this.menu.download.addEventListener('click', this_function(this.download, this), false);
                this.menu.save.addEventListener('click', this_function(this.save, this), false);
